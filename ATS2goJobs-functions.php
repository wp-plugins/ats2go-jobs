		...
		register_post_type( 
			...
			array( 
				'labels' => array(
					...
					'add_new'					=> __('Add icamsjob', 'ATS2goJobs'),
					'add_new_item'		=> __('Add icamsjob', 'ATS2goJobs'),
					'edit'						=> __('Edit icamsjob', 'ATS2goJobs'),
					'edit_item'				=> __('Edit icamsjob', 'ATS2goJobs'),
					'new_item'				=> __('New icamsjob', 'ATS2goJobs'),
					'view'						=> __('View icamsjob', 'ATS2goJobs'),
					'view_item'				=> __('View icamsjob', 'ATS2goJobs'),
					'search_items'		=> __('Search icamsjob', 'ATS2goJobs'),
					'not_found'				=> __('No icamsjob found', 'ATS2goJobs'),
					'not_found_in_trash' => __('No icamsjob found in Trash', 'ATS2goJobs'),
					'parent'				  => __('Parent icamsjob', 'ATS2goJobs'),
				),
